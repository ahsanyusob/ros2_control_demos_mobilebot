...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "slowdown", default_value="50.0", description="Slowdown factor of the Robot."
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("ros2_control_demo_bicycledrivebot_carlike"),
                    "urdf",
                    "carlikebot_separate_sensors_and_actuators.urdf.xacro",
                ]
            ),
            " ",
            "prefix:=",
