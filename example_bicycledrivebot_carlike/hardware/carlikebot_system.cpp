...
#include "ros2_control_demo_bicycledrivebot_carlike/carlikebot_system.hpp"
...
hardware_interface::return_type ros2_control_demo_bicycledrivebot_carlike ::CarlikeBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  ros2_control_demo_bicycledrivebot_carlike::CarlikeBotSystemHardware, hardware_interface::SystemInterface)
