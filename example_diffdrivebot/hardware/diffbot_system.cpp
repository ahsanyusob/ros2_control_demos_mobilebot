...
#include "ros2_control_demo_diffdrivebot/diffbot_system.hpp"
...
namespace ros2_control_demo_diffdrivebot
{
...
hardware_interface::return_type ros2_control_demo_diffdrivebot ::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  ros2_control_demo_diffdrivebot::DiffBotSystemHardware, hardware_interface::SystemInterface)
